...
/*
Efe: We reverted back to the original due to possible spipio and tftmaster.h integration issues. 
You just need to rewire Jack. 

UPDATE: I did the rewiring of the tft.
*/

#define SCK   17   // stays the same
#define MOSI  18   // MUST be adjacent to SCK
#define CS    19   // moved here
#define DC    16
#define RST   20
